      ...
      <main className="flex-1 flex flex-col relative overflow-hidden" style={{ paddingTop: '120px' }}>
        <div className="px-6 md:px-12 py-16 md:py-24 max-w-[90rem] mx-auto w-full relative z-10">
          ...
          <div className="max-w-3xl text-base md:text-lg space-y-8" style={{ color: 'var(--cinematic-text-secondary)', fontWeight: 300 }}>
            <div>
              <h3 className="text-xl font-bold mb-3 text-[var(--cinematic-text)]">1. SPF Rating Verification</h3>
            ...
            <div>
              <h3 className="text-xl font-bold mb-3 text-[var(--cinematic-text)]">2. Ingredient List Accuracy</h3>
            ...
            <div>
              <h3 className="text-xl font-bold mb-3 text-[var(--cinematic-text)]">3. Consistency and Color</h3>
            ...
            <div>
              <h3 className="text-xl font-bold mb-3 text-[var(--cinematic-text)]">4. Regulatory Approval Marks</h3>
            ...
            <div>
              <h3 className="text-xl font-bold mb-3 text-[var(--cinematic-text)]">5. The Smell Test</h3>
